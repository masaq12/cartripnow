...
$pageTitle = 'Car Trip Now - Book Vehicles, Share Cars, Earn Money';
...
try {
    ...
    // Get wishlist items for logged in renters
    $wishlist_items = [];
    if (isRenter()) {
...
<div class="turo-hero">
    <div class="container">
        <h1 style="font-size: 56px; font-weight: 700; margin-bottom: 16px;">
            Find the perfect car to explore your city
        </h1>
        <p style="font-size: 20px; margin-bottom: 0;">
            Book incredible cars from trusted owners
        </p>
    </div>
</div>
...
<div class="container">
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; margin-top: 40px; margin-bottom: 20px;">
        ...
        <?php if (isRenter()): ?>
            <a href="<?php echo SITE_URL; ?>/guest/wishlist.php" class="btn btn-outline" style="padding: 8px 16px;">
    ...
    <?php else: ?>
        <div class="vehicle-grid">
            <?php foreach ($vehicles as $vehicle): ?>
                <div class="vehicle-card" onclick="location.href='<?php echo SITE_URL; ?>/listing_public.php?id=<?php echo $vehicle['vehicle_id']; ?>'">
                    <?php if (isRenter()): ?>
    ...
    <?php if (!isLoggedIn() && !empty($vehicles)): ?>
        <!-- CTA Section -->
        <div class="card" style="text-align: center; margin-top: 60px; padding: 60px 20px; background: linear-gradient(135deg, #FF385C 0%, #FF6B85 100%); color: white;">
            <h2 style="font-size: 36px; margin-bottom: 20px; color: white;">Ready to hit the road?</h2>
            <p style="font-size: 18px; margin-bottom: 30px; opacity: 0.95;">
                Join thousands of travelers and find your perfect ride
            </p>
            <div style="display: flex; gap: 15px; justify-content: center; flex-wrap: wrap;">
                <a href="<?php echo SITE_URL; ?>/register.php?type=renter" class="btn" style="background: white; color: #FF385C; padding: 14px 32px; font-size: 16px; font-weight: 600;">
                    Sign up to book
                </a>
                <a href="<?php echo SITE_URL; ?>/register.php?type=owner" class="btn" style="background: rgba(255,255,255,0.2); color: white; padding: 14px 32px; font-size: 16px; font-weight: 600; border: 2px solid white;">
                    List your car
                </a>
            </div>
        </div>
